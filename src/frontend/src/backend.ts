...
import type { ApprovalStatus as _ApprovalStatus, Kwarran as _Kwarran, UserApprovalInfo as _UserApprovalInfo, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Kwarran]): Kwarran | null {
    return value.length === 0 ? null : value[0];
}
