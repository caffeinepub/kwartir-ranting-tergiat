...
export class Backend implements backendInterface {
    ...
    async addBannerImage(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createKwarran(arg0: Kwarran): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createKwarran(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteKwarran(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteKwarran(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getKwarran(arg0: bigint): Promise<Kwarran | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getKwarran(arg0);
    ...
    async listBannerImages(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.listBannerImages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listKwarran(): Promise<Array<Kwarran>> {
        if (this.processError) {
            try {
    ...
    async removeBannerImage(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeBannerImage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateKwarran(arg0: bigint, arg1: Kwarran): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateKwarran(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Kwarran]): Kwarran | null {
    return value.length === 0 ? null : value[0];
}
